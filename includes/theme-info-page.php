...
$not_provided = __( 'Not provided in the stylesheet header', 'af-theme' );
...
<div class="wrap theme-info-page">
	<h1><?php _e( 'Active Theme Information', 'af-theme' ); ?></h1>
	<p class="description"><?php echo apply_filters( 'igp_theme_page_description', $get_theme_desc ); ?></p>
	<hr />
	<main>
		<h2><?php echo apply_filters( 'igp_theme_page_details_title', esc_html__( 'Theme Details', 'af-theme' ) ); ?></h2>
		<ul>
			<li><strong><?php esc_html_e( 'Theme Name: ', 'af-theme' ); ?></strong><?php echo $get_theme_name; ?></li>
			<?php if ( $get_template ) : ?>
				<li><strong><?php _e( 'Template: ', 'af-theme' ); ?></strong><?php echo $parent_name; ?></li>
			<?php endif; ?>
			<li><strong><?php esc_html_e( 'Theme URI: ', 'af-theme' ); ?></strong><?php echo $theme_uri; ?></li>
			<li><strong><?php esc_html_e( 'Author: ', 'af-theme' ); ?></strong><?php echo $author; ?></li>
			<li><strong><?php esc_html_e( 'Author URI: ', 'af-theme' ); ?></strong><?php echo $author_uri; ?></li>
			<li><strong><?php esc_html_e( 'Description: ', 'af-theme' ); ?></strong><?php echo $description; ?></li>
			<li><strong><?php esc_html_e( 'Version: ', 'af-theme' ); ?></strong><?php echo $version; ?></li>
			<li><strong><?php esc_html_e( 'Text Domain: ', 'af-theme' ); ?></strong><?php echo $domain; ?></li>
			<li><strong><?php esc_html_e( 'Tags: ', 'af-theme' ); ?></strong><?php echo implode( ', ', $tags ); ?></li>
		</ul>
